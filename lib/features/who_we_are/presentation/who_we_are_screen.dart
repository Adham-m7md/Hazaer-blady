      ...
      body: Padding(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              const Text(
                'نحن تطبيق مبتكر يربط بين أصحاب الحضائر والتجار، مما يسهل عملية بيع وشراء الدجاج اللاحم بكل سهولة وشفافية. عبر التطبيق، يمكنك استكشاف العروض المتاحة، التفاوض على الأسعار، وإتمام الصفقات بأمان وسرعة. سواء كنت مربيًا أو تاجرًا، ستجد في "حضائر بلادي" أداة فعالة لتنمية أعمالك وتوسيع شبكتك التجارية.',
